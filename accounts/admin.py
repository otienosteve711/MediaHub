'''import admin avails all inbuilt operations for content management'''
...
# step 1: utilize the admin decorator to register your model
@admin.register(User)
class CustomUserAdmin(UserAdmin):
    # override the list display of the user information
    ...
    # UserAdmin.fieldsets points to existing django fields then we add our added fields
