...
# abstractuser is the inbuilt class allowing us to override our custom auth django setup
...
class User(AbstractUser):
    ...
    profile_image=models.ImageField(upload_to='pofiles/',null=True,blank=True)
